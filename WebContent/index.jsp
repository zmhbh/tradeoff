			...
			<div class="well">
				<div class="form-group row">
					<div class="col-lg-6 col-md-6 col-xs-6">
							<div>
							<input style="" type="text" name="querycompanies"
							 id="querycompanies">
							 <input style="" type="button"
							value="Request Value" class="btn" id="requestvalue">
							</div>
							<br />
							<div>
							<input style="" type="text" name="queryvalues"
							 id="queryvalues">
							 <select id="valuelist">
							 </select>
							 <input style="" type="button"
							value="Request Data" class="btn" id="request">
							</div>
